...
// The pins configured here are the native spi pins for HSPI interface --> ???HSPI??? --> VSPI
// Any other valid pin combination can be used
#define PIN_NUM_MISO 19		// SPI MISO native would be : 
#define PIN_NUM_MOSI 23		// SPI MOSI
#define PIN_NUM_CLK  18		// SPI CLOCK pin
...
#define DEFAULT_GAMMA_CURVE 0
#define DEFAULT_SPI_CLOCK   32000000  //on native SPI pins 32MHz seems possible
//#define DEFAULT_DISP_TYPE   DISP_TYPE_ILI9341
#define DEFAULT_DISP_TYPE   DISP_TYPE_ST7735R //it seems as if 7735B and R both work ...
//----------------------------------------------------------------------------
